...
public class DataLocationPanel extends RmaJPanel
{
	...
	private CfpAltPanel _parentPanel;
	private JButton _button;

	public DataLocationPanel(CfpAltPanel cfpAltPanel)
	{
	...
	{
		String hdr1 = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_HEADER_NAME).getText();
		String hdr2 = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_HEADER_PARAMETER).getText();
		String hdr3 = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_HEADER_TYPE).getText();
		String hdr4 = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_HEADER_USER_DEF_FIELD).getText();
		...
		_button.setText(
				CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_HEADER_SET_FIELD).getText());
		...
		_addBtn = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_BUTTON_ADD).createJButton();
				//new JButton("Add");
		gbc.gridx     = GridBagConstraints.RELATIVE;
		gbc.gridy     = GridBagConstraints.RELATIVE;
		gbc.gridwidth = 1;
		...
		_deleteBtn = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_BUTTON_DELETE).createJButton();
				//new JButton("Delete");
		gbc.gridx     = GridBagConstraints.RELATIVE;
		gbc.gridy     = GridBagConstraints.RELATIVE;
		gbc.gridwidth = GridBagConstraints.REMAINDER;
	...
	private void deleteLocationAction()
	{
		...
		String msg = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_DELETE_LOC_MSG).getText();
				//"Do you want to delete the selected DataLocations?";
		String title =CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_DELETE_LOC_MSG_TITLE).getText(); 
				//"Confirm Deletion";
	...
	public class DataLocationTableModel extends AbstractRmaTableModel
	{
		...
		public Object getValueAt(int row, int col)
		{
			...
			switch ( col )
			{
				...
				case 2:
					return dl.getType();
				case 3:
					return CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_HEADER_SET_FIELD)
							.getText();
			}
			return null;
		}
		...
		public void addRow(Vector newRow)
		{
			...
			String param = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_DEFAULT_PARAM).getText();
		...
		private String getNextDlName()
		{
			...
			String defName = CfpI18n.getI18n(CfpMessages.DATALOCATION_PANEL_DEFAULT_NAME).getText();
