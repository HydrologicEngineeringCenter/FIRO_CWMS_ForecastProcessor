...
public class CfpAltPanel extends AbstractEditorPanel
{
	private static final Logger LOGGER = Logger.getLogger(CfpAltPanel.class.getName());
	...
	{
		_tabName = CfpI18n.getI18n(CfpMessages.EDITOR_PANEL_TAB_NAME).getText();
	...
	private void buildBottomTabs()
	{
        ...
        String dataTitle = CfpI18n.getI18n(CfpMessages.EDITOR_PANEL_DATA_LOC_TITLE).getText(); //"Data Locations"));
	...
	private JPanel buildDataPanel() {
        ...
        JLabel label = CfpI18n.getI18n(CfpMessages.EDITOR_PANEL_TIME_STEP_LABEL).createJLabel();
        ...
        _timeStepCombo.setSelectedItem(CfpI18n.getI18n(CfpMessages.EDITOR_PANEL_TIME_STEP_DEFAULT).getText());
        ...
        String title = CfpI18n.getI18n(CfpMessages.EDITOR_PANEL_INPUT_TITLE).getText();
        //"Input"
        tabbedPane.addTab(title, _inputPanel);
        title = CfpI18n.getI18n(CfpMessages.EDITOR_PANEL_OUTPUT_TITLE).getText();
        //"Output"
	...
	{
		if ( !(dobj instanceof CfpAlternative) )
		{
			return;
		}
		_alt = (CfpAlternative)dobj;
